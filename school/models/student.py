...
class StudentStudent(models.Model):
    ...
    def create(self, vals_list):
        ...
        res = super(StudentStudent, self).create(vals_list)
    ...
    def write(self, vals):
        ...
        if vals.get("parent_id"):
            for parent in vals.get("parent_id")[0]:
                for data in teacher.search([("stu_parent_id", "in", parent)]):
    ...
    def admission_done(self):
        ...
        for rec in self:
            ...
            # Assign Is student true for student
            rec.user_id.partner_id.write({
                'is_student':True,
                'student_id':self.id                                
            })
